...
export default function BuyersView() {
  ...
  const buyersList = [
    { id: 1, businessName: "Al-Fateh Shopping Galleria", contactPerson: "Asad Noor", city: "Lahore", orders: 48, spent: "Rs. 2,450,000", type: "Corporate Wholesale", status: "Active", initial: "AF" },
    { id: 2, name: "Imtiaz Super Market Procurement", contactPerson: "Shahid Raza", city: "Karachi", orders: 112, spent: "Rs. 6,800,000", type: "Enterprise Bulk", status: "Active", initial: "IS" },
    { id: 3, name: "Chase Up Retail Chain", contactPerson: "Farhan Siddiqui", city: "Karachi", orders: 34, spent: "Rs. 1,920,000", type: "Corporate Wholesale", status: "Active", initial: "CU" },
    { id: 4, name: "ChenOne Stores Sourcing", contactPerson: "Zubair Khan", city: "Faisalabad", orders: 29, spent: "Rs. 1,450,000", type: "Corporate Wholesale", status: "Active", initial: "CO" },
    { id: 5, name: "Pakland Construction Pvt Ltd", contactPerson: "Kamran Malik", city: "Islamabad", orders: 18, spent: "Rs. 3,100,000", type: "Contractor Account", status: "Active", initial: "PC" },
    { id: 6, name: "Khyber General Traders", contactPerson: "Bilal Ahmad", city: "Peshawar", orders: 12, spent: "Rs. 540,000", type: "Small Business", status: "Active", initial: "KG" },
  ];
    ...
    <div className="p-8 max-w-[1240px] mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
        <div className="bg-white p-5 rounded-[20px] border border-[#E9E8E2] shadow-2xs hover:border-[#85A6A3] transition-all">
          <span className="text-[12px] font-medium text-[#5B5B58] uppercase tracking-wider">Total Registered Buyers</span>
          <h4 className="text-[26px] font-semibold text-black tracking-tight mt-1">1,842</h4>
        </div>
        <div className="bg-white p-5 rounded-[20px] border border-[#E9E8E2] shadow-2xs hover:border-[#85A6A3] transition-all">
          <span className="text-[12px] font-medium text-[#5B5B58] uppercase tracking-wider">Active Corporate Accounts</span>
          <h4 className="text-[26px] font-semibold text-[#85A6A3] tracking-tight mt-1">1,210</h4>
        </div>
        <div className="bg-white p-5 rounded-[20px] border border-[#E9E8E2] shadow-2xs hover:border-[#85A6A3] transition-all">
          <span className="text-[12px] font-medium text-[#5B5B58] uppercase tracking-wider">Wholesale Orders</span>
          <h4 className="text-[26px] font-semibold text-black tracking-tight mt-1">4,890</h4>
        </div>
        <div className="bg-white p-5 rounded-[20px] border border-[#E9E8E2] shadow-2xs hover:border-[#85A6A3] transition-all">
          <span className="text-[12px] font-medium text-[#5B5B58] uppercase tracking-wider">Total Spend (MTD)</span>
          <h4 className="text-[26px] font-semibold text-black tracking-tight mt-1">Rs. 18.5M</h4>
        </div>
      </div>
                ...
                <tr key={b.id} className="text-[14px] hover:bg-[#F9F9F6]/50 transition-colors">
                  <td className="py-3.5">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-semibold text-black text-[14px]">{name}</span>
                    </div>
                  </td>
                  <td className="py-3.5 text-[#5B5B58] text-[13px] font-normal">{b.contactPerson}</td>
                  <td className="py-3.5 text-black text-[13px] font-medium">{b.city}</td>
                  <td className="py-3.5 text-right font-semibold text-black text-[13px]">{b.orders}</td>
                  <td className="py-3.5 text-right text-[#5B5B58] font-medium text-[13px]">{b.spent}</td>
                  <td className="py-3.5 text-[#5B5B58] text-[13px] font-normal">{b.type}</td>
