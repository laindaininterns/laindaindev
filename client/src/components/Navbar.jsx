          ...
          {currentUser ? (
            <div className="flex items-center gap-2">
              <button
                ...
                className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#EEF3F2] hover:bg-[#E2EBE9] text-[13px] font-medium text-black border border-[#E9E8E2] transition-colors active:scale-[0.98]"
              >
                <span>👤</span>
