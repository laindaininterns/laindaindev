    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="h-[40px] px-4 rounded-[12px] bg-[#A3C1BF] text-black text-[13px] font-semibold hover:bg-[#85A6A3] transition-all active:scale-[0.97] cursor-pointer flex items-center gap-1.5"
        >
          <span>+</span> Add New Product
        </button>
      </div>

      {/* When 0 products, display an intuitive empty state */}
      {products.length === 0 ? (
        <div className="bg-white rounded-[24px] border border-[#E9E8E2] p-10 text-center flex flex-col items-center justify-center min-h-[360px] shadow-xs">
          ...
          <h3 className="text-[18px] font-semibold text-black">No products added yet</h3>
          <p className="text-[13px] text-[#5B5B58] max-w-[380px] mt-1 mb-6 leading-relaxed">
            Your catalog is currently empty. Click below to add your first wholesale product and make it available across the marketplace.
          </p>
          <button
            onClick={onOpenAddModal}
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex flex-col items-end gap-1.5">
                    ...
                    <button
                      ...
                      className="text-[12px] text-[#85A6A3] hover:text-[#5B5B58] transition-colors flex items-center gap-1 font-medium cursor-pointer"
                    >
                      Edit ✏️
                    </button>
                  </div>
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className="h-8 w-8 rounded-[8px] bg-[#EEF3F2] hover:bg-[#E9E8E2] text-black font-semibold text-[14px] transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
                      -
                    </button>
